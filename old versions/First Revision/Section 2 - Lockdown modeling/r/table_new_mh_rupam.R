...
if (mh == TRUE) {
  case_out  <- here("lockdown", "rupam", "table_mh_mhs_cases.txt")
  death_out <- here("lockdown", "rupam", "table_mh_mhs_deaths.txt")
} else if (kl == TRUE) {
  case_out  <- here("lockdown", "rupam", "table_kl_mhs_cases.txt")
  death_out <- here("lockdown", "rupam", "table_kl_mhs_deaths.txt")
} else {
  case_out  <- here("lockdown", "rupam", "table_mhs_cases.txt")
  death_out <- here("lockdown", "rupam", "table_mhs_deaths.txt")
}
