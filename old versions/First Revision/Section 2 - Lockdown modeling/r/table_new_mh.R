...
if (mh == TRUE) {
  case_out  <- here("lockdown", "output", "table_mh_mhs_cases.txt")
  death_out <- here("lockdown", "output", "table_mh_mhs_deaths.txt")
} else if (kl == TRUE) {
  case_out  <- here("lockdown", "output", "table_kl_mhs_cases.txt")
  death_out <- here("lockdown", "output", "table_kl_mhs_deaths.txt")
} else {
  case_out  <- here("lockdown", "output", "table_mhs_cases.txt")
  death_out <- here("lockdown", "output", "table_mhs_deaths.txt")
}
