...
model_predictR <- function(data, data_init, init_pars = NULL, N, plot = TRUE, T_predict, period_start,end_beta, estimate = TRUE,pi,
  ...
  if(estimate == FALSE){
    ...
    cat("  ", fill = T)
    mcmc_estimate = model_estimateR(data = data, data_init = data_init, init_pars = init_pars, N = N,end_beta=end_beta,
  ...
  var_init = model_initializeR(data = data, data_init = data_init, init_pars = NULL, N = N, end_beta=end_beta,
