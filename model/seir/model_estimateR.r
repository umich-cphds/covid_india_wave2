...
model_estimateR <- function(data, data_init,N, init_pars = NULL, niter = 1e5, BurnIn = 5e3,
                            model = "Multinomial", plot = TRUE, period_start, end_beta, auto.initialize = TRUE,
                            ... ){
  library(dplyr)
  ...
  var_init = model_initializeR(data = data, data_init = data_init, init_pars = init_pars, model = model, end_beta=end_beta,
