...
saveRDS(Result,"Result_Tier4_1.rds")


tier4_1=readRDS("Result_Tier4_1.rds")
Prediction4_1=tier4_1$prediction
dime=(nrow(Prediction4_1)/14)
P_daily=rowMeans(Prediction4_1[dime*9+1:dime,])
