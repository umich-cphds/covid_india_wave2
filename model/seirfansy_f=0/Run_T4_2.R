...
saveRDS(Result,"Result_Tier4_2.rds")


tier4_2=readRDS("Result_Tier4_2.rds")
Prediction4_2=tier4_2$prediction
dime=(nrow(Prediction4_2)/14)
P_daily=rowMeans(Prediction4_2[dime*9+1:dime,])
