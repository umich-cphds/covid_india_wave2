...
feb_19_mar_30 <- period_summary(scen = glue("t2_r{r_0}"), scen_start = as.Date("2021-02-19"), end_date = "2021-03-30", waning = wane, cfr_sched = cfr_sched, mh = mh)
feb_19_apr_15 <- period_summary(scen = glue("t2_r{r_0}"), scen_start = as.Date("2021-02-19"), end_date = "2021-04-15", waning = wane, cfr_sched = cfr_sched, mh = mh)
feb_19_apr_30 <- period_summary(scen = glue("t2_r{r_0}"), scen_start = as.Date("2021-02-19"), end_date = "2021-04-30", waning = wane, cfr_sched = cfr_sched, mh = mh)
feb_19_may_15 <- period_summary(scen = glue("t2_r{r_0}"), scen_start = as.Date("2021-02-19"), end_date = "2021-05-15", waning = wane, cfr_sched = cfr_sched, mh = mh)
feb_19_may_30 <- period_summary(scen = glue("t2_r{r_0}"), scen_start = as.Date("2021-02-19"), end_date = "2021-05-30", waning = wane, cfr_sched = cfr_sched, mh = mh)
feb_19_jun_15 <- period_summary(scen = glue("t2_r{r_0}"), scen_start = as.Date("2021-02-19"), end_date = "2021-06-15", waning = wane, cfr_sched = cfr_sched, mh = mh)
...
write_csv(cases_out, glue("table 1.csv"))
...
# )
# write_csv(deaths_out, glue("table2.csv"))
