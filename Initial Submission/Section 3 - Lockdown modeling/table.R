...
# save tables -----------
if (mh == TRUE) {
  case_out  <- here("Section 3 - Lockdown modeling", "out", "table_mh_cases.txt")
  death_out <- here("Section 3 - Lockdown modeling", "out", "table_mh_deaths.txt")
} else if (kl == TRUE) {
  case_out  <- here("Section 3 - Lockdown modeling", "out", "table_kl_cases.txt")
  death_out <- here("Section 3 - Lockdown modeling", "out", "table_kl_deaths.txt")
} else {
  case_out  <- here("Section 3 - Lockdown modeling", "out", "table_cases.txt")
  death_out <- here("Section 3 - Lockdown modeling", "out", "table_deaths.txt")
}
