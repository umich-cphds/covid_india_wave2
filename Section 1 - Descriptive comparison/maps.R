...
ggsave("/Users/soumikp/Dropbox (University of Michigan)/COVIND19_Science_2021/code/study 1/images/resubmission/cases_2021_08_19.png", p.cases, dpi = 300, width = 35, height = 35, units = "cm")
...
p.deaths <- ggplot(states_population %>% 
  ...
  theme(legend.text = element_text(size=12), 
        legend.title = element_text(size=14))
ggsave("/Users/soumikp/Dropbox (University of Michigan)/COVIND19_Science_2021/code/study 1/images/resubmission/deaths_2021_08_19.png", p.deaths, dpi = 300, width = 35, height = 35, units = "cm")
system("say Code finished!")
