...
source("figures/figure_s14/esir_ally.R")
...
# data ------------
dat <- fread("figures/figure_s14/covid19india_national_counts_20211031.csv")[, date := as.Date(date)]
...
feb_19 <- extracto(
  x     = glue("figures/figure_s14/2021-02-19_t2_r2_forecast_MCMC.RData"),
...
mar_13 <- extracto(
  x     = glue("figures/figure_s14/2021-03-13_t3_r2_forecast_MCMC.RData"),
...
mar_19 <- extracto(
  x     = glue("figures/figure_s14/2021-03-19_t4_r2_forecast_MCMC.RData"),
...
mar_30 <- extracto(
  x     = glue("figures/figure_s14/2021-03-30_t4_r2_forecast_MCMC.RData"),
...
apr_15 <- extracto(
  x     = glue("figures/figure_s14/2021-04-15_t4_r2_forecast_MCMC.RData"),
...
ggsave(
  filename = glue("figures/figure_s14/figure s14.pdf"),
  plot = full_plot,
  width = 8, height = 9,
  device = cairo_pdf
)
