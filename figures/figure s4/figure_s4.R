...
r_plot_data <- covid19india::get_r0(dat = india, inc_days = c(7, 7, 7))[, .(place, date, r)][, r_t7 := frollmean(r, n = 7)][data.table::between(date, start, end)][]
...
ggsave(
  filename = "figures/figure s4/figure_s4.pdf",
  plot = r_plot,
  width = 9, height = 5,
  device = cairo_pdf
)
...
ggsave(
  filename = "figures/figure s4/figure_s4.png",
