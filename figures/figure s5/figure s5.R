...
source("figures/figure s5/esir_ally.R")
...
d0 <- fread("figures/figure s5/2021-02-19_t2_r2_data.txt")[, `:=` (start_date = "2021-02-19", tier = "Tier 2", scenario = "Tier 2 - February 19")]
d1 <- fread("figures/figure s5/2021-03-13_t3_r2_data.txt")[, `:=` (start_date = "2021-03-13", tier = "Tier 3", scenario = "Tier 3 - March 13")]
d2 <- fread("figures/figure s5/2021-03-19_t4_r2_data.txt")[, `:=` (start_date = "2021-03-19", tier = "Tier 4", scenario = "Tier 4 - March 19")]
d3 <- fread("figures/figure s5/2021-03-30_t4_r2_data.txt")[, `:=` (start_date = "2021-03-30", tier = "Tier 4", scenario = "Tier 4 - March 30")]
d4 <- fread("figures/figure s5/2021-04-15_t4_r2_data.txt")[, `:=` (start_date = "2021-04-15", tier = "Tier 4", scenario = "Tier 4 - April 15")]
...
patched <- deaths_p_kl / deaths_p_mh 
...
# save output ----------
ggsave(filename = glue("figures/figure s5/figure s5.pdf"),
       plot     = full_plot,
       height   = 12,
       width    = 15,
       device   = cairo_pdf)
